...
public class EscapismTendency() : CuteAnonCard(1, CardType.Power, CardRarity.Uncommon, TargetType.Self)
{
    ...
    {
        get { yield return HoverTipFactory.FromPower<EscapismTendencyPower>(); }
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        var amount = DynamicVars["EscapismTendencyPower"].IntValue;
