...
public class CuteSakiCardPool : CustomCardPoolModel
{
    public override string Title => Character.CuteSaki.CharacterId; //This is not a display name.
    ...
    public override float V => 0.5f; //Brightness
