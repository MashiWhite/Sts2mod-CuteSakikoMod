...
namespace CuteSakikoMod.CuteSakikoModCode.Events
{
    ...
    public sealed class StarAnonEvent : ModEventTemplate
    {
        ...
        protected override IReadOnlyList<EventOption> GenerateInitialOptions()
        {
            ...
            {
                new EventOption(this, PickUpWatch, InitialOptionKey("PICK_UP"), relicTips),
                new EventOption(this, KickAway, InitialOptionKey("KICK_AWAY"))
            };
        }
        ...
        private async Task KickAway()
        {
            ...
            if (cardsToRemove.Any())
            {
                ...
                await CardPileCmd.RemoveFromDeck((IReadOnlyList<CardModel>)list, false);
            }
